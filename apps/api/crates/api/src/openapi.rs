...
#[openapi(
    ...
    paths(
        ...
        crate::auth::totp::totp_status,
        crate::auth::totp::totp_start,
        crate::auth::totp::totp_enable,
        crate::auth::totp::totp_disable,
        crate::auth::totp::totp_verify,
        crate::auth::totp::admin_reset_totp,
        ...
        crate::admin::moderation::admin_list_items,
        crate::admin::moderation::admin_owners_tree,
        ...
        crate::trade::handlers::proposal_chain,
