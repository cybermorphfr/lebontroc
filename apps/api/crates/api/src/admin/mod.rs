...
pub fn router() -> Router<AppState> {
    ...
    Router::new()
        ...
        .route("/admin/items", get(moderation::admin_list_items))
        .route(
            "/admin/items/arborescence",
            get(moderation::admin_owners_tree),
        )
        .route(
            "/admin/items/{id}/moderer",
            post(moderation::admin_moderate_item),
        )
        .route("/admin/users/suggest", get(moderation::admin_suggest_users))
        .route(
